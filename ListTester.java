...
public class ListTester {
	...
	private void runTests() {
		...
		testThreeElementList(CA_addToRearB_CAB, "CA_addToRearB_CAB", LIST_CAB, STRING_CAB);
		...
		testThreeElementList(AAB_set0C_CAB, "AAB_set0C_CAB", LIST_CAB, STRING_CAB);
...
//			break;
	...
	private IndexedUnsortedList<Integer> CA_addToRearB_CAB() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.addToFront(ELEMENT_C);
		list.addToRear(ELEMENT_A);
		list.addToRear(ELEMENT_B);
	...
	private Scenario<Integer> CA_addToRearB_CAB = () -> CA_addToRearB_CAB();
	
	private IndexedUnsortedList<Integer> AAB_set0C_CAB() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.addToFront(ELEMENT_C);
		list.addToRear(ELEMENT_A);
		list.addToRear(ELEMENT_B);
	...
	private Scenario<Integer> AAB_set0C_CAB = () -> AAB_set0C_CAB();
